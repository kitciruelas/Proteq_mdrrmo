-- Welfare Check System Setup
-- Run this in your MySQL database to create the necessary tables

USE proteq_mdrrmo;

-- Create welfare_check_settings table if it doesn't exist
CREATE TABLE IF NOT EXISTS `welfare_check_settings` (
...
-- Create welfare_reports table if it doesn't exist
...
-- Insert default welfare check settings if none exist
INSERT IGNORE INTO `welfare_check_settings` (`is_active`, `title`, `description`, `message_when_disabled`, `created_by`) 
...
SHOW TABLES LIKE 'welfare_%';

-- Show the default settings
SELECT * FROM welfare_check_settings;
